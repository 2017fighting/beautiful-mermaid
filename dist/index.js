...
var DEFAULT_MONO_FONT = "JetBrains Mono";
var MIX = {
...
function buildStyleBlock(font, monoFont) {
...
function renderClassSvg(diagram, colors, font = "Inter", transparent = false, monoFont = DEFAULT_MONO_FONT) {
  const parts = [];
  parts.push(svgOpenTag(diagram.width, diagram.height, colors, transparent));
  parts.push(buildStyleBlock(font, monoFont));
  parts.push("<defs>");
...
function renderErSvg(diagram, colors, font = "Inter", transparent = false, monoFont = DEFAULT_MONO_FONT) {
  const parts = [];
  parts.push(svgOpenTag(diagram.width, diagram.height, colors, transparent));
  parts.push(buildStyleBlock(font, monoFont));
  parts.push("<defs>");
...
function renderMermaidSVG(text, options = {}) {
  ...
  const monoFont = options.monoFont ?? DEFAULT_MONO_FONT;
  ...
  switch (diagramType) {
    ...
    case "class": {
      ...
      return renderClassSvg(positioned, colors, font, transparent, monoFont);
    }
    case "er": {
      const diagram = parseErDiagram(lines);
      const positioned = layoutErDiagramSync(diagram, options);
      return renderErSvg(positioned, colors, font, transparent, monoFont);
    }
    case "xychart": {
      const chart = parseXYChart(lines);
